...
The time costed by different method is shown in Table III.

\begin{table}
	\caption{Time Costed by Different Method(to be continue)}
	\begin{center}
		\begin{tabular}{c c c}
			\toprule
			$N$ &Plain&Two-dimensional array\\
			\hline
			 $ikj$  &    $n^2$    &    $2n^2+n$  \\  
 $kij$  &   $2n^2$      &   $3n^2$     \\
 $jik$ & $n^{3}+n^2+n$  & $n^3+2n^2$   \\
